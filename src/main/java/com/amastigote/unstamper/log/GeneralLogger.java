...
public class GeneralLogger {
  ...
  public static class File {
    ...
    public static void nameDuplicate(String fn) {
      System.err.println(
          suffix + "Input file/dir \'" + fn + "\' has the same name as output file/dir, skipping");
    }

    public static void notExist(String fn) {
      System.err
          .println(suffix + "File/dir \'" + fn + "\' not exist or is not a file/dir, skipping");
    }

    public static void error(String fn) {
      System.err
          .println(suffix + "Error when generating stub file/dir for \'" + fn + "\', skipping");
    }
